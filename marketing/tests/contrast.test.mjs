...
test("every token the page relies on was actually parsed", () => {
  const need = [
    "bone", "panel", "ink", "soft", "faint", "line", "line2", "green", "greenwash",
    "amber", "amberwash", "melon", "melonwash", "seed", "pithcream", "rinddark",
    "con-bg", "con-chrome", "con-text", "con-dim", "con-key", "con-str",
    "con-red", "con-grn", "con-amb", "con-label", "con-tabon", "green-hov", "amber-ink",
  ];
